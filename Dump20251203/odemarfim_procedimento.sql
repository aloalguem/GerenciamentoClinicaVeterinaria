...
CREATE TABLE `procedimento` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKmsslcjvq3rpywd0j6m65igf2a` (`veterinario_id`),
  CONSTRAINT `FKmsslcjvq3rpywd0j6m65igf2a` FOREIGN KEY (`veterinario_id`) REFERENCES `pessoa` (`id`)
...
INSERT INTO `procedimento` VALUES (2,'Cirurgia',1000,11),(3,'Banho e tosa',100,11);
